                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#tab_staff_permissions" aria-controls="tab_staff_permissions" role="tab"
                                   data-toggle="tab">
                           ...
                           <?php echo $base_currency->symbol; ?>
                                ...
                                <div class="form-group">
                                    <?php if (count($levels) > 0) { ?>
                                        <label for="levels"><?php echo _l('staff_add_edit_levels'); ?></label>
                                    <?php } ?>
                                        ...
                                        <div class="checkbox checkbox-primary">
                                            ...
                                            if (isset($member)) {
                                                foreach ($staff_levels as $staff_level) {
                                                    if ($staff_level['levelid'] == $level['id']) {
                                                        $checked = ' checked';
                                                    }
                                                }
                                            }
                                            ?>
                                            <input type="checkbox" id="level_<?php echo $level['id']; ?>"
                                                   name="levels[]"
                                                   value="<?php echo $level['id']; ?>" <?php echo $checked; ?>>
                                            <label for="level_<?php echo $level['id']; ?>"><?php echo $level['department']; ?>
                                                (<?php echo $level['position']; ?>)</label>
                                        </div>
                                    <?php } ?>
                                </div>
